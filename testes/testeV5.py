...
KNOWN_WIDTH_CM = 8.5
# O valor que você calculou na calibração
...
def detect_squares_in_frame(frame, center_x, center_y):
    ...
    error_x = 0
    error_y = 0
    distance_cm = 0 # ### NOVO: Inicializa a distância
...
def main():
    ...
    while True:
        ...
        cv.putText(processed_frame, text_distance, (430, 25), cv.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
